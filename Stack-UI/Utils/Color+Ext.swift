...
//  Stack-UI
//
//  Created by Adinlewa Olutayo on 23/06/2024.
//
...
extension Color {
    ...
    public static let offWhite = Color(red:250, green:249, blue:246)
    public static let greyColor = Color(red:139, green:149, blue:166)
    public static let lightRed = Color(red: 231, green: 76, blue: 60)
    public static let appDarkPink = Color(red: 222, green: 73, blue: 110)
    public static let appLightPink = Color(red: 255, green: 110, blue: 145)
